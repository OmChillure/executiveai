    ...
    <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent">
      <div className="mx-auto max-w-3xl px-6 lg:max-w-6xl">
        <div className="mx-auto grid gap-16 lg:grid-cols-2">
          ...
          {/* Added text element as per wireframe */}
          <div className="flex items-center justify-center text-5xl font-bold">Text</div>
          ...
          {/* Added text element as per wireframe */}
          <div className="flex items-center justify-center text-5xl font-bold lg:col-span-2">Text</div>
        </div>
      </div>
    </section>
  )
